export function LocationMap({ query, label, caption }: { query: string; label: string; caption?: string }) {
  ...
  return (
    <section className="mx-auto max-w-4xl px-4 pb-16 sm:px-6">
      ...
      {caption && <p className="mt-1 text-sm text-brand-ink-2/70">{caption}</p>}
