  ...
  return (
    <>
      ...
      {route.pickupSteps && route.pickupSteps.length > 0 && (
        <section className="border-b border-brand-line bg-white">
          <div className="mx-auto max-w-4xl px-4 py-16 sm:px-6">
            <h2 className="font-display text-xl text-brand-ink">So funktioniert Ihre Abholung ab {route.from}</h2>
      ...
      {route.routeOverview && (
        <section className="border-b border-brand-line bg-white">
          <div className="mx-auto max-w-4xl px-4 py-16 sm:px-6">
            <h2 className="font-display text-xl text-brand-ink">Welches Fahrzeug sollten Sie wählen?</h2>
            <div className="mt-6 overflow-x-auto">
