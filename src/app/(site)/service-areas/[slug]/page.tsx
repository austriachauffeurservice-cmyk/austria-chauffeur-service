      ...
      <>
          ...
          <section className="border-b border-brand-line bg-brand-cream">
            <div className="mx-auto max-w-4xl px-4 py-16 sm:px-6">
              ...
              <p className="mt-3 text-xs text-brand-ink-2/60">
                ...
                luggage or ski equipment when requesting a quote so we can assign the appropriate
                vehicle.
              </p>
        ...
        {isEnriched && bookingSteps && bookingSteps.length > 0 && (
          <section className="border-t border-brand-line bg-white">
            <div className="mx-auto max-w-4xl px-4 py-16 sm:px-6">
              <h2 className="font-display text-xl text-brand-ink">Booking Your {city} Transfer</h2>
